...
# mesh = rok.RectangleMesh(nx, ny, 1.0, 1/nx, quadrilateral=True)
...
nsteps = 400       # the number of time steps
cfl = 0.3
...
file_species_amounts = fire.File('results/demo-reactivetransport/species-amounts.pvd')
file_element_amounts = fire.File('results/demo-reactivetransport/element-amounts.pvd')
file_porosity = fire.File('results/demo-reactivetransport/porosity.pvd')
file_volume = fire.File('results/demo-reactivetransport/volume.pvd')
